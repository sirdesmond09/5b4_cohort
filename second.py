...
# total_shipping = shipping_price + (additional_shipping_price * (num_of_copies-1))
...
# b = '20'
# print(a+b)
student = "dolapo d is a student"

# print(student.lower())
# print(student.upper())
# print(student.title())
# print(student.capitalize())
# print(student.count("o"))
# a = student.replace("dolapo", "chukwudi")
# print(a)
# print(student.find("d"))
